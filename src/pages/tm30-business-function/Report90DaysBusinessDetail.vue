<template>
  <div class="max-w-xl mx-auto p-6 bg-white shadow-lg rounded-lg">
    <h1 class="text-2xl font-bold mb-6 text-gray-800">Report 90 Day Business Details</h1>
    ...
    <div v-if="report90Day" class="details-form space-y-4">
      <div class="form-group">
          <label class="block text-gray-700 font-medium mb-1">Order Id:</label>
          <input v-model="report90Day.order_id" type="text" class="w-full p-2 border rounded-md bg-gray-100 cursor-not-allowed" readonly />
        </div>

        <div class="form-group">
          <label class="block text-gray-700 font-medium mb-1">VisaType:</label>
          <input v-model="report90Day.visaType" type="text" class="w-full p-2 border rounded-md bg-gray-100 cursor-not-allowed"  readonly/>
        </div>
      ...
      <div class="form-group">
        ...
        <input v-model="report90Day.userName" type="text" class="w-full p-2 border rounded-md bg-gray-100 cursor-not-allowed" readonly />
      </div>

      <div class="form-group">
        <label class="block text-gray-700 font-medium mb-1">Contact Number:</label>
        <input v-model="report90Day.contactNumber" type="text" class="w-full p-2 border rounded-md bg-gray-100 cursor-not-allowed"  readonly />
      </div>

      <div class="form-group">
        <label class="block text-gray-700 font-medium mb-1">Status:</label>
        <input v-model="report90Day.status" type="text" class="w-full p-2 border rounded-md bg-gray-100 cursor-not-allowed" readonly />
      </div>
